...
!(function () {
...
})()(
    {
            ...
            function (e, t, n) {
                ...
                !(function () {
                    ...
                    if (true) {
                        ...
                        var i = function (e, t) {
                                for (; (e = e.parentElement) && !(e.matches || e.matchesSelector || e.msMatchesSelector).call(e, t); );
                                return e;
                            },
                            s = function () {
                        ...
                        (window.onkeyup = function (e) {
                            ...
                            t
                                .get("https://api.glitch.com/projects/" + n)
                                .then(function (e) {
                                    var t = e.data;
                                    if (!t) return null;
                                    var n = t.domain,
                                        ...
                                        o = t.users.map(function (e) {
                                            return e.login
                                                ? '<li><a href="'
                                                      .concat("//glitch.com/@")
                                                      .concat(e.login, "?utm_source=button&utm_medium=button&utm_campaign=glitchButton&utm_contnet=")
                                                      .concat(n, '"><img width="25px" src="')
                                                      .concat(e.avatarThumbnailUrl, '" alt="avatar of ')
                                                      .concat(e.login, '" /> <span class="name">')
                                                      .concat(e.login, "</span></a></li>")
                                                : null;
                                        }),
                                        ...
                                        c = '<div class="embedGlitchCode"><label>Copy and paste this code anywhere you want to embed this app.<textarea><div class="glitch-embed-wrap" style="height: 486px; width: 100%;">\n  <iframe\n    allow="geolocation; microphone; camera; midi; encrypted-media"\n    src="https://glitch.com/embed/#!/embed/'
                                            .concat(n, '?previewSize=100&previewFirst=true&sidebarCollapsed=true"\n    alt="')
                                            .concat(n, ' on Glitch"\n    style="height: 100%; width: 100%; border: 0;">\n  </iframe>\n</div></textarea>')
                                            .concat(s, ' to customize the embed under the "Share" menu.</label></div>'),
                                        u = '<div class="project">\n          <div class="projectInfo">\n            <div class="name"><a href="https://glitch.com/~'
                                            .concat(n, "?utm_source=button&utm_medium=button&utm_campaign=glitchButton&utm_content=")
                                            .concat(n, '">')
                                            .concat(n, '</a></div>\n            <p class="description">')
                                            .concat(r, '</p>\n            <div class="users">\n              <ul>')
                                            ...
                                            .concat(i, "<br /> ")
                                            .concat(s, "<br /> ")
                                            .concat('<button class="buttonLinks embed">Embed This App</button>', '</div>\n          <div class="projectEmbed">')
                                            .concat(c, "</div>\n        </div>"),
                                        l = document.getElementsByClassName("glitchButton");
                                    [].forEach.call(l, function (e) {
                                        var t = document.createElement("button");
                                        (t.className = "glitchButtonElement"),
                                            (t.innerHTML = '<img alt="This is a Glitch app!" width="50px" src="'.concat("https://cdn.glitch.com/3fd2e3a7-3145-4c1d-9480-32a2e6a6963a%2Flogo-day.svg?1490800908258", '" />'));
                                        var n = document.createElement("div");
                                        (n.className = "glitchOpenWindowElement"),
                                            (n.style.display = "none"),
                                            (n.innerHTML = "".concat(u, ' <span class="tooltip border"></span><span class="tooltip fill"></span>')),
                                            (t.onclick = a),
                                            e.appendChild(t),
                                            e.appendChild(n),
                                            (e.getElementsByClassName("embed")[0].onclick = function (t) {
                                                var n, r, o, i;
                                                (r = (n = e).getElementsByClassName("projectInfo")[0]),
                                                    (o = n.getElementsByClassName("projectActions")[0]),
                                                    (i = n.getElementsByClassName("projectEmbed")[0]),
                        ...
                        return new Promise(function (l, f) {
                            ...
                            if (
                                ("test" === n.env.NODE_ENV ||
                                    ...
                                    a(t.url) ||
                                    ((d = new window.XDomainRequest()), (m = "onload"), (v = !0), (d.onprogress = function () {}), (d.ontimeout = function () {})),
                                t.auth)
                            ) {
        ...
        15: [
            ...
            { "./adapters/http": 3, "./adapters/xhr": 3, "./helpers/normalizeHeaderName": 23, "./utils": 26, _process: 29 },
        ],
        16: [
            function (e, t, n) {
                "use strict";
            ...
            function (e, t, n) {
                (function (r, o) {
                    !(function (e, r) {
                        ...
                        function L(e, n, r) {
                            n.constructor === e.constructor && r === E && n.constructor.resolve === x
                                ? (function (e, t) {
                                      t._state === S
                                          ? k(e, t._result)
                                          : t._state === j
                        ...
                        var H = (function () {
                            function e(e, t) {
                                (this._instanceConstructor = e),
                                    ...
                                    this.promise[C] || M(this.promise),
                                    n(t)
                                        ? ((this.length = t.length),
                                          (this._remaining = t.length),
                                          (this._result = new Array(this.length)),
                                          0 === this.length ? k(this.promise, this._result) : ((this.length = this.length || 0), this._enumerate(t), 0 === this._remaining && k(this.promise, this._result)))
